      ...
      <main>
        <div className="tripdetails-page">
          ...
          <div className="flex justify-center gap-4 mb-6 border-b border-gray-300">
            <NavLink to={`/trips/${tripId}/floatplan`} className={({ isActive }) => isActive
            ? "trip-tab-link trip-tab-link-active"
            : "trip-tab-link"}>
              Float Plan
            </NavLink>
            <NavLink to={`/trips/${tripId}/meals`} className={({ isActive }) => isActive
            ? "trip-tab-link trip-tab-link-active"
            : "trip-tab-link"}>
              Meals
            </NavLink>
            <NavLink to={`/trips/${tripId}/gear`} className={({ isActive }) => isActive
            ? "trip-tab-link trip-tab-link-active"
            : "trip-tab-link"}>
              OarGanizer
            </NavLink>
            <NavLink to={`/trips/${tripId}/crew`} className={({ isActive }) => isActive
            ? "trip-tab-link trip-tab-link-active"
            : "trip-tab-link"}>
              Crew
            </NavLink>
